...
export function ActuatorRow({
  ...
  return <TableRow>
    ...
    <TableCell className="whitespace-nowrap text-sm text-muted-foreground" title={actuator.last_db_updated_at ? formatDateTime(actuator.last_db_updated_at) : undefined}>{actuator.last_db_updated_at ? formatVietnamTime(actuator.last_db_updated_at) : "Chưa có dữ liệu"}</TableCell>
