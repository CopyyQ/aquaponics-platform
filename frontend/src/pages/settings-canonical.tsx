...
export function SettingsPage() {
  ...
  useEffect(() => { setSystemDraft({ code: system.code, name: system.name, location: system.location, description: system.description }) }, [system])
